...
<body>
<form action="<%=request.getContextPath()%>/suser/editUsercfg" method="post" id="form1">
	<input type="hidden" name="id" value="${usercfg.id}"/>
	<table width="50%" cellspacing="0" cellpadding="2" class="dataTable">
		<tbody>
			...
			<tr>
				...
				<td><input type="text" name="channelid" value="${usercfg.channelid}" /></td>
			</tr>
		</tbody>
	</table>
