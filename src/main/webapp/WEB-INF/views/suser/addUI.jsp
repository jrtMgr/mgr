...
<body>
<form action="<%=request.getContextPath()%>/suser/add" method="post" id="form1">
	<table width="50%" cellspacing="0" cellpadding="2" class="dataTable">
		<tbody>
			...
			<tr>
				...
				<td><input type="text" name="name" value=""/>&nbsp;<font color="red" size="24px;">*</font></td>
			</tr>
			<tr>
				<td align="right">密码: </td>
				<td><input type="text" name="pass" value=""/>&nbsp;<font color="red"  size="24px;">*</font></td>
			</tr>
			<tr>
