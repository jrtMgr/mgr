		...
		<tbody>
			<tr>
				<td style="padding: 2px 10px;">
					<form action="<%=request.getContextPath()%>/datastat/saledata"
						method="post">
				...
				<td	style="padding-top: 2px; padding-left: 6px; padding-right: 6px; padding-bottom: 2px;">
					<table width="100%" cellspacing="0" cellpadding="2" class="dataTable">
						...
						<tr class="dataTableHead">
						     <td width="28%" class="thOver" colspan="2"><strong>彩种购彩用户数：${count}</strong></td>
						     <td width="72%" class="thOver" colspan="3"><strong>彩种销量（单位分）：${amt}</strong></td>
						</tr>
						<tr class="dataTableHead">
								<td width="4%" height="30" class="thOver"></td>
								<td width="24%" class="thOver"><strong>彩种编号</strong></td>
								<td width="24%" class="thOver"><strong>彩种名称</strong></td>
								<td width="24%" class="thOver"><strong>购彩用户数</strong></td>
								<td width="24%" class="thOver"><strong>销量（单位分）</strong></td>								
						</tr>
