...
<body>
		<form name="notesForm" action="<%=request.getContextPath()%>/tlotstrategy/adde" method="post" onSubmit="checkAll();">
			<table class="dataTable" style="width: 50%">
				<tr>
					<td colspan="2" align="center"><strong>新增兑奖策略</strong></td>
				</tr>
			  <tr>
			  ...
			  <tr>
			  	...
			  	<td><input id="amt" type="text" name="amt" value="${param.amt}"><font color="red">必填</font></td>
			  </tr>
			  <tr>
