		...
		<tbody>
			<tr>
				<td style="padding: 2px 10px;">
					<form action="<%=request.getContextPath()%>/tawardlevel/list"
						method="post">
			...
			<tr>
				<td
					...
					<table width="99%" cellspacing="0" cellpadding="2"
						...
						<tbody>
							<tr>
								<td class="thOver" colspan="8">追加信息</td>
							</tr>
							<tr class="dataTableHead">
								<td class="thOver"><strong>采种</strong></td>
								<td class="thOver"><strong>奖等</strong></td>
							...
							<tr>
								<td colspan="8" align="left"><a style="cursor:hand; font-size: 12px;" href="<%=request.getContextPath()%>/tawardlevel/addADUI?lotno=${param.lotno}">新增加奖</a></td>
							</tr>
						</tbody>
					</table>
				</td>
