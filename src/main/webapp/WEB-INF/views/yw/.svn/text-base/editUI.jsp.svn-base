...
<body>
<form action="<%=request.getContextPath()%>/yw/edit" method="post" id="form1">
	<input type="hidden" name="id" value="${yw.id}"/>
	<table width="50%" cellspacing="0" cellpadding="2" class="dataTable">
		<tbody>
			...
			<tr>
				...
				<td><input type="text" name="code" value="${yw.code}"/></td>
			</tr>
			<tr>
				<td align="right">业务名 : </td>
				<td><input type="text" name="name" value="${yw.name}"/></td>
			</tr>
			<tr>
				<td align="right">备注:  </td>
				<td><input type="text" name="bz" value="${yw.bz}"/></td>
			</tr>
		</tbody>
	</table>
