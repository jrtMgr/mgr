		...
		<tbody>
			<tr>
				<td style="padding: 2px 10px;">
					<form action="<%=request.getContextPath()%>/tcharges/alipay"
						method="post">
						<div style="float: left;">
							<table width="100%" cellspacing="2" cellpadding="2" border="0">
								<tr>
								  ...
								  <td><input name="bankorderid" type="text" style="width: 180px" value="${bankorderid}"
										id="bankorderid" class="inputText" onfocus="this.select();" /></td>
								  <td align="right"></td>
								  <td align="center"><input type="submit" value="查询" class="inputButton">&nbsp;&nbsp;&nbsp;
									<input type="button" value="重置" onclick="javascript:location.href='<%=request.getContextPath() %>/tcharges/alipay';" class="inputButton">
				...
				<td	style="padding-top: 2px; padding-left: 6px; padding-right: 6px; padding-bottom: 2px;">
					<table width="100%" cellspacing="0" cellpadding="2" class="dataTable">
						...
						<tr class="dataTableHead">
						     <td width="100%" class="thOver" colspan="2"><strong>支付宝订单明细</strong></td>
						</tr>
				        ...
				        <tr><td></td><td>
				        	<c:if test='${"TRADE_FINISHED" eq trade_status2 || "TRADE_SUCCESS" eq trade_status2}'>				        	
				        	 <a href="<%=request.getContextPath() %>/tcharges/doChargeProcess?amt=${total_fee}&ttransactionid=${out_trade_no}
				        	 &bankorderid=${trade_no}&banktrace= &retcode=${trade_status2}&retmemo=${trade_status2}&bankordertime=${gmt_payment}&flag=alipay">置为成功</a>				        
				        	</c:if>				       
				        </td></tr>			     
				</tbody>
				</table>
