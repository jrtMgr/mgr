						...
						<div style="float: left;">
							<table width="100%" cellspacing="2" cellpadding="2" border="0">
								<tr>
									...
									<td align="center"></td>
									<td align="center"><a href="<%=request.getContextPath()%>/tuserinfoes/nineteenpaylist?userno=${userno}">充值卡明细</a></td>
									<td align="center"></td>
									<td align="center"><a href="<%=request.getContextPath()%>/tuserinfoes/dnapaylist?userno=${userno}">DNA明细</a></td>									
								</tr>
							</table>
						</div>
					</form>
					...
					<table width="100%" cellspacing="0" cellpadding="2"
						...
						<tbody>
							<tr class="dataTableHead">
								...
								<td width="8%" class="thOver"><strong>如意卡卡号</strong></td>
								<td width="11%" class="thOver"><strong>充值时间</strong></td>
								...
								<td width="8%" class="thOver"><strong>错误码</strong></td>
								<td width="8%" class="thOver"><strong>银行返回</strong></td>
								<td width="10%" class="thOver"><strong>备注</strong></td>
								<td width="8%" class="thOver"><strong>渠道</strong></td>
							</tr>
							<% 
							...
							%>
								<c:forEach items="${page.list}" var="transaction" varStatus="num">
									...
									String ttransactionId = ttransaction.getId();
									if ("gyj001".equals(ttransaction.getBankid())) {
										ttransactionId = "<a href='" + request.getContextPath() + "/tuserinfoes/nineteenpaylist?transactionid=" + ttransactionId + "'>" + ttransactionId + "</a>";
									} else if ("dna001".equals(ttransaction.getBankid())) {
										ttransactionId = "<a href='" + request.getContextPath() + "/tuserinfoes/dnapaylist?transactionid=" + ttransactionId + "'>" + ttransactionId + "</a>";
									} else if ("szf001".equals(ttransaction.getBankid())) {
										ttransactionId = "<a href='" + request.getContextPath() + "/tuserinfoes/nineteenpaylist?transactionid=" + ttransactionId + "'>" + ttransactionId + "</a>";
									}
								%>
									<tr>
										<td title="${num.count}">${num.count}</td>
										<td title="${transaction.id}"><%=ttransactionId%></td>
										...
										<td title="${transaction.retcode}">${transaction.retcode}</td>
