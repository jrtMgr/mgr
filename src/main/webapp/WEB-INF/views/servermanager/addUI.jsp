...
<body>
<form action="<%=request.getContextPath()%>/servermanager/add" method="post" id="form1">
	<table width="50%" cellspacing="0" cellpadding="2" class="dataTable">
		<tbody>
			<tr class="dataTableHead">
				<td height="30" class="thOver" colspan="3" align="center"><strong>新增</strong>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="2"><input type="text" name="jmx" style="width: 300px;"/></td>
			</tr>
			<tr>
				<td align="right">备注 : </td>
				<td colspan="2"><input type="text" name="bz" value=""/></td>
			</tr>
		</tbody>
	</table>
