...
<body>
<form action="<%=request.getContextPath()%>/agent/add" method="post" id="form1">
	<table width="50%" cellspacing="0" cellpadding="2" class="dataTable">
		<tbody>
			...
			<tr>
				...
				<td><input type="text" name="userno" value=""/>&nbsp;<font color="red" size="24px;">*</font></td>
			</tr>
			<tr>
				<td align="right">上级用户编号: </td>
				<td><input type="text" name="parentUserno" value=""/></td>
			</tr>
		</tbody>
	</table>
