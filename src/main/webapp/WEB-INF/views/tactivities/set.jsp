...
<body>
	...
	<form action="<%=request.getContextPath()%>/tactivities/set" method="post">
					...
					<table width="100%" cellspacing="0" cellpadding="2"
						...
						<tbody>
							<tr class="dataTableHead">
								<td height="30" class="thOver" colspan="4" width="100%">活动维护</td>								
							</tr>
							<tr>
							...
							<tr>
							    ...
							    <td width="42%" align="left"><input name="channel" type="text" style="width: 120px" 
										id="channel" class="inputText" onfocus="this.select();" value="${channel}"/></td>
							</tr>
							<tr>
