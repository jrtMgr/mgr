...
<body>
	...
	<form action="<%=request.getContextPath()%>/tactivities/setbatch" method="post">
					...
					<table width="100%" cellspacing="0" cellpadding="2"
						...
						<tbody>
							<tr class="dataTableHead">
								<td height="30" class="thOver" colspan="4" width="100%">活动批量维护</td>								
							</tr>
							<tr>
							    <td width="8%" align="right">维护条件（如下）：</td>
							    <td width="92%" align="left" colspan="3"></td>							  
							</tr>
							<tr>
							...
							<tr><td width="8%" align="right">渠道：</td>
							    <td width="92%" align="left" colspan="3">
							         ...
							         ${channel}</textarea>（如果全部渠道，请填all。渠道间用英文逗号隔开，如：1,2,3 ）
							         </td></tr>			
							<tr>
							<tr>
							    <td width="8%" align="right">维护目标（如下）：</td>
							    <td width="92%" align="left" colspan="3"></td>							  
							</tr>
							<tr>
