...
<body>
<form action="<%=request.getContextPath()%>/lssm/addTI" method="post" id="form1">
	<table width="40%" cellspacing="0" cellpadding="2" class="dataTable">
		<tbody>
		<tr class="dataTableHead">
			...
			<tr>
				...
				<td align="left"><input name="startHour" id="startHour" type="text" style="width: 120px" class="inputText" onfocus="this.select();"/></td>
			</tr>
			<tr>
				<td height="30" align="right">结束时间：</td>
				<td align="left"><input name="endHour" id="endHour" type="text" style="width: 120px" class="inputText" onfocus="this.select();"/></td>
			</tr>
			<tr>
				<td height="30" align="right">间隔时间（分钟）：</td>
				<td align="left"><input name="frequency" id="frequency" type="text" style="width: 120px" class="inputText" onfocus="this.select();"/></td>
			</tr>
			<tr>
				<td height="30" align="right">手机号码（多个用","分割）：</td>
